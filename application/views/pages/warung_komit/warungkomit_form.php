    ...
    <div class="content">
        <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $button?> Pelanggan Warung Komitmen</h3>
            </div>
            <form action="<?php echo $action?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <input type="hidden" class="form-control" name="kd_warungkomit" id="kd_warungkomit" value="<?php echo $kd_warungkomit; ?>" />
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="varchar" class="col-sm-2 control-label">Ongkir diatas 3 - 10 KM :</label>
                    <div class="col-sm-10">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url('warungkomit')?>" class="btn btn-default">Cancel</a>
