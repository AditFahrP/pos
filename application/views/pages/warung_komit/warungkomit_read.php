      ...
      <div class="col-xs-12 col-lg-12">
        <div class="box">
          <div class="box-header" style="display: flex; justify-content: space-between; align-items: center;">
            <h3 class="box-title"><?php echo $button?> Pelanggan Warung</h3>
            <a class="btn bg-purple" style="margin-left: auto; border-radius: 20px;" href="<?php echo site_url('warung/update/'.$kd_warung) ?>">Udate Pelanggan Warung</a>
                </div>
              <!-- /.box-header -->
              <div class="box-body">
