            ...
            <div class="col-xs-12 col-lg-12">
                <div class="box">
                  <div class="box-header" style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="box-title">DAFTAR PELANGGAN WARUNG</h3>
                    <div class="box-title text-green" style="text-align: center; flex: 1;"  id="message">
                      <?php echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?>
                    </div>
                    <a class="btn bg-purple" style="margin-left: auto; border-radius: 20px;" href="<?php echo site_url('warung/create')?>">Tambah Pelanggan Warung</a>
                </div>
