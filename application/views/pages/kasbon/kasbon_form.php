<div class="content-wrapper">
    <div class="content">
        <div class="box box-info">
            ...
            <input type="hidden" class="form-control" name="kd_kasbon" id="kd_kasbon" value="<?php echo $kd_kasbon; ?>" />
            <div class="box-body">
            <div class="form-group">
                  <label for="varchar" class="col-sm-2 control-label">Tanggal Kasbon</label>
                  <div class="col-sm-10">
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input value="<?php echo $tgl_kasbon?>" type="text" class="form-control" id="datepicker" name="tgl_kasbon" required placeholder="Masukan tanggal kasbon">
                    </div>
                  </div>
                </div>
                <div class="form-group">
              ...
              <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input value="<?php echo $jml_hutang?>" type="text" class="form-control" id="jml_hutang" name="jml_hutang" placeholder="Masukan total hutang" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="saldo_akhir" name="saldo_akhir">
              </div>
