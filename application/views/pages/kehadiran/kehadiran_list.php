            ...
            <div class="col-xs-12 col-lg-12">
                <div class="box">
                  <div class="box-header" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a class="btn bg-purple" style="margin-left: auto; border-radius: 20px;" href="<?php echo site_url('kehadiran/create') ?>">Tambah Kehadiran</a>
                </div>
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <table id="mytable10" class="table table-bordered table-hover">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Tanggal</th>
